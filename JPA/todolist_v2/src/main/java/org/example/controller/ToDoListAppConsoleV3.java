...
public class ToDoListAppConsoleV3 {
        ...
        public static void main() {
            ...
            do {
                ...
                System.out.println("111. Ajouter un utilisateur");
                System.out.println("222. Supprimer un utilisateur");
                System.out.println("333. Voir les tâches d'un utilisateur");
        ...
        private static void addUser(Scanner scanner){
            ...
            if (userDAO.addUser(user)){
                System.out.println("Bienvenue mon petit pote... Au boulot Maintenant!");
            }else{
                System.out.println(" Oopsie X﹏X ");
            }
