package com.example.demospringdatarest.exo_candy_shop.config;
...
@Configuration
public class ValidatorAfterEventRegistry implements InitializingBean {
    //La liste des validators enregistré dans Spring
    @Autowired
